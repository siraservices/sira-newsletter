...
async function generateWeekly() {
  try {
    // Predefined values for this week's newsletter
    const topic = "AI Tools That Actually Save Time in 2025";
    const tone = "hormozi";
    const audience = "Small business owners and entrepreneurs looking to scale efficiently";
    ...
    console.log(chalk.bold('Word Limit: ') + chalk.cyan('450 words'));
    console.log('');
